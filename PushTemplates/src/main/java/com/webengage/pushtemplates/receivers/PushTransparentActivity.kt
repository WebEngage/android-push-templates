...
/**
 * Starting Android 12, notifications cannot have pending intents which which start Activities
 * indirectly via Service/Receiver. For devices targeting Android12, use the Transparent Activity
 * to start deeplink intents.
 */
