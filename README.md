...
>
> All push notification templates provided here (Progress Bar, CountDown Timer, Banner, etc.) are now **natively supported** in the [WebEngage Android SDK]([https://docs.webengage.com/docs/changelogs-android]) **v4.8.0 and above** .
>
